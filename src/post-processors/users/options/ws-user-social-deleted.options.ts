...
import { WS_USER_SOCIAL_DELETED_POST_PROCESSOR_OPTIONS } from '../../options/constants.js';

export const wsUserSocialDeletedOptionsProvider = {
  provide: WS_USER_SOCIAL_DELETED_POST_PROCESSOR_OPTIONS,
  useFactory: (appConfig: AppConfigService) => ({
    groupName: 'SocialConsumer',
    streamName: getEventStreamName(Streams.WS_USER_DELETED_FEEDBACK),
