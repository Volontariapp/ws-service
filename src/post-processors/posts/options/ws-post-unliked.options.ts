...
import { WS_POST_UNLIKED_POST_PROCESSOR_OPTIONS } from '../../options/constants.js';

export const wsPostUnlikedOptionsProvider = {
  provide: WS_POST_UNLIKED_POST_PROCESSOR_OPTIONS,
  useFactory: (appConfig: AppConfigService) => ({
    groupName: 'WsPostUnlikedGroup',
    streamName: getEventStreamName(Streams.POST_UNLIKED),
