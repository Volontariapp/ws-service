...
import { WS_POST_SOCIAL_CREATED_POST_PROCESSOR_OPTIONS } from '../../options/constants.js';

export const wsPostSocialCreatedOptionsProvider = {
  provide: WS_POST_SOCIAL_CREATED_POST_PROCESSOR_OPTIONS,
  useFactory: (appConfig: AppConfigService) => ({
    groupName: 'WsPostSocialCreatedGroup',
