...
import { WS_POST_EVENT_DELETED_SUCCESS_POST_PROCESSOR_OPTIONS } from '../../options/constants.js';

export const wsPostEventDeletedSuccessOptionsProvider = {
  provide: WS_POST_EVENT_DELETED_SUCCESS_POST_PROCESSOR_OPTIONS,
  useFactory: (appConfig: AppConfigService) => ({
    groupName: 'PostEventDeletedSuccessConsumer',
