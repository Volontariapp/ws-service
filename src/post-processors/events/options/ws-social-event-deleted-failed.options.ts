...
import { WS_SOCIAL_EVENT_DELETED_FAILED_POST_PROCESSOR_OPTIONS } from '../../options/constants.js';

export const wsSocialEventDeletedFailedOptionsProvider = {
  provide: WS_SOCIAL_EVENT_DELETED_FAILED_POST_PROCESSOR_OPTIONS,
  useFactory: (appConfig: AppConfigService) => ({
    groupName: 'SocialEventDeletedFailedConsumer',
