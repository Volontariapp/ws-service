...
import { WS_SOCIAL_EVENT_DELETED_SUCCESS_POST_PROCESSOR_OPTIONS } from '../../options/constants.js';

export const wsSocialEventDeletedSuccessOptionsProvider = {
  provide: WS_SOCIAL_EVENT_DELETED_SUCCESS_POST_PROCESSOR_OPTIONS,
  useFactory: (appConfig: AppConfigService) => ({
    groupName: 'SocialEventDeletedSuccessConsumer',
