...
import { WS_EVENT_GEOCODED_POST_PROCESSOR_OPTIONS } from '../../options/constants.js';

export const wsEventGeocodedOptionsProvider = {
  provide: WS_EVENT_GEOCODED_POST_PROCESSOR_OPTIONS,
  useFactory: (appConfig: AppConfigService) => ({
    groupName: 'GeocodedConsumer',
