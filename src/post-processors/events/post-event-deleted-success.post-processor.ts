...
import { PostEventMessagingType, EventEventMessagingType, SagaGatherType } from '@volontariapp/messaging';
...
@Injectable()
export class PostEventDeletedSuccessPostProcessor extends BaseWebSocketGatherPostProcessor<
  PostEventMessagingType.POST_EVENT_DELETED_SUCCESS,
...
> {
  ...
  protected override shouldProcess(eventType: PostEventMessagingType | string): boolean {
    return eventType === PostEventMessagingType.POST_EVENT_DELETED_SUCCESS.toString();
  }
}
